        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="p-4 border border-border-color rounded-lg">
            ...
            <div className="mt-3">
              ...
              {dispositionFilePreview && !dispositionFile && <p className="text-xs text-text-light mt-1">File terlampir: <a href={`/app${dispositionFilePreview}`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">{document.disposition_attachment_filename || 'Lihat File'}</a></p>}
          ...
          <div className="p-4 border border-border-color rounded-lg">
            ...
            <div className="mt-3">
              ...
              {followUpFilePreview && !followUpFile && <p className="text-xs text-text-light mt-1">File terlampir: <a href={`/app${followUpFilePreview}`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">{document.response_original_filename || 'Lihat File'}</a></p>}
